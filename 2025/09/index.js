...
const failTest = moveReno(board, 'D')
console.log(failTest) // ➞ 'fail' -> it moves but doesn't pick anything up

const sucessTest = moveReno(board, 'U')
console.log(sucessTest) // ➞ 'success' -> it picks something up (*) right above

const crashTest = moveReno(board, 'RU')
console.log(crashTest) // ➞ 'crash' -> it crashes into an obstacle (#)